...
<body class="easyui-layout" data-options="fit:true,border:false">
		...
		<div id="dlg" class="easyui-dialog" style="width:360px;padding:10px 20px"
	        ...
	        <form id="fm" method="post" enctype="multipart/form-data">
	            ...
	            <div class="fitem">
	                <label>岗位名称:</label>
	                <input name="jobName" class="easyui-textbox" required="true">
	            </div>
	            <div class="fitem">
	                <label>岗位简介:</label>
	                <input name="jobDescription" class="easyui-textbox" required="true" multiline="true" style="height: 100px;">
	            </div>
	            <div class="fitem">
	                <label>招聘要求:</label>
	                <input name="demand" class="easyui-textbox" required="true" multiline="true" style="height: 100px;">
	            </div>
	            <div class="fitem">
	                <label>起始时间:</label>
	                <input name="startDate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" required="true"/>
	            </div>
	            <div class="fitem">
	                <label>结束时间:</label>
	               	<input name="endDate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" required="true"/>
	            </div>
	        </form>
	    </div>
	    <div id="dlg-buttons">
