	        ...
	        <form id="fm" method="post" enctype="multipart/form-data">
	            ...
	            <div class="online">
					...
					<div class="d-float f-width">
						<input id="tempId" name="tempId" class="easyui-textbox" required="true" />
					</div>
				</div>
				<div class="online">
					<div class="lable l-width">模板标题</div>
					<div class="d-float f-width">
						<input id="tempTitle" name="tempTitle" class="easyui-textbox" required="true" />
					</div>
				</div>
				<div class="online">
					<div class="lable l-width">模板内容</div>
					<div class="d-float f-width">
						<input required="true" class="easyui-textbox text-area" id="tempContent" name="tempContent" multiline="true" style="height: 100px;width: 92%;" prompt="在此填写对短信模板" />
					</div>
				</div>
	        </form>
	    </div>
