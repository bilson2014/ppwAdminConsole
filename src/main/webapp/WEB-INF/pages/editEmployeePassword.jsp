		...
		<div data-options="region:'center',border:true" style="overflow: hidden;">
			<form id="editUserPwdForm" method="post">
				<table>
					...
					<tr>
						<th>原密码</th>
						<td><input name="oldPwd" type="password" placeholder="请输入原密码" class="easyui-validatebox text-box" data-options="required:true"></td>
					</tr>
					<tr>
						<th>新密码</th>
						<td><input name="pwd" type="password" placeholder="请输入新密码" class="easyui-validatebox text-box" data-options="required:true"></td>
					</tr>
					<tr>
						<th>重复密码</th>
						<td><input type="password" placeholder="请再次输入新密码" class="easyui-validatebox text-box" data-options="required:true,validType:'eqPwd[\'#editUserPwdForm input[name=pwd]\']'"></td>
					</tr>
				</table>
			</form>
		</div>
