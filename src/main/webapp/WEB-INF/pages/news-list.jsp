...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons" title="新闻信息">
		<form id="fm" method="post" enctype="multipart/form-data">
			<input id="newsId" name="id" type="hidden"> <input
				type="hidden" name="picLDUrl" />
			<div class="online">
				<label class="lable l-width">新闻标题</label> <input id="title"
					name="title" class="easyui-textbox" required="true" /> <label
					class="lable l-width">是否显示到主页</label> <select id="status"
					name="status" required="true" editable="false"
					class="easyui-combobox" style="width: 138px;">
					<option value="1" selected>显示</option>
					<option value="0">不显示</option>
				</select> <label class="lable l-width">是否可见</label> <select id="visible"
					name="visible" required="true" editable="false"
					class="easyui-combobox" style="width: 138px;">
			...
			<br>
			<div class="online">
				<label class="lable l-width">新闻描述</label> <input id="discription"
					name="discription" multiline="true"
					class="easyui-textbox text-area" required="true"
					style="height: 100px; width: 82%;" />
			</div>
			<br>
			<div class="online">
				<label class="lable l-width">新闻标签</label> <input id="tags"
					name="tags" class="easyui-textbox" style="width: 82%" />
			</div>
			<br>
			<div class="online">
				<label class="lable l-width">新闻封面</label> <input type="file"
					id="picLDUrlFile" name="picLDUrlFile" />
			</div>
			<br>
			<div class="online">
				<label class="lable l-width">新闻推荐值</label> <input type="text"
					id="recommend" class="easyui-numberbox" name="recommend" />
			</div>
			<br>
	...
	<div id="dlg-buttons">
		...
		<r:mulparampermission uri2="/portal/news/save"
			uri="/portal/news/update">
