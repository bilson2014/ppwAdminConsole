...
<spring:url value="/resources/lib/My97DatePicker/WdatePicker.js"
	var="WdatePickerJs" />
<spring:url value="/resources/js/finance-offline.js"
	var="financeOfflineJs" />
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" enctype="multipart/form-data">
			<input name="dealId" type="hidden"> <input type="hidden"
				class="textbox-value" name="logType1" value=""> <input
				id="projectName" name="projectName" type="hidden"> <input
				id="userName" name="userName" type="hidden">
			<div class="fitem">
				<label>交易流水号:</label> <input name="unOrderId" class="easyui-textbox"
					required="true" />
			</div>
			<div class="fitem">
				<label>项目名称:</label> <input id="projectId" name="projectId"
					class="easyui-combobox" required="true" />
			</div>
			<div class="fitem">
				<label>交易时间:</label> <input name="payTime"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					readonly="readonly" required="true" />
			</div>
			<div class="fitem">
				<label>交易类型:</label> <input id="logType" name="logType"
					class="easyui-combobox" required="true" />
			</div>
			<div class="fitem">
				<label>交易方:</label> <input id="userId" name="userId"
					class="easyui-combobox" required="true" />
			</div>
			<div class="fitem">
				<label>交易金额:</label> <input name="payPrice" class="easyui-numberbox"
					required="true" precision="2" />
			</div>
			<div class="fitem">
				<label>描述:</label> <input class="easyui-textbox text-area"
					id="description" name="description" multiline="true"
					style="height: 100px; width: 92%;" prompt="在此填写对交易记录的描述" />
			</div>
		</form>
	</div>
	<div id="dlg-buttons">

		<r:mulparampermission uri2="/portal/finance/save"
			uri="/portal/finance/update">
