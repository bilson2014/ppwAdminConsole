...
<body class="easyui-layout" data-options="fit:true,border:false">
		...
		<div id="dlg" class="easyui-dialog" style="width:400px; height:380px;padding:10px 20px"
            ...
            <form id="fm" method="post" >
	            ...
	            <div class="fitem">
	                <label>事件名称：</label>
	                <input name="nodesEventName" id="nodesEventName" class="easyui-textbox" required="true">
	            </div>
	            <div class="fitem">
	                <label>事件描述:</label>
	                <input name="nodesEventDescription" id="nodesEventDescription" class="easyui-textbox" required="true">
	            </div>
	            <div class="fitem">
	                <label>事件类路径:</label>
	                <input name="nodesEventClassName" id="nodesEventClassName" class="easyui-combobox" required="true">
	            </div>
	            <div class="fitem">
	                <label>事件类型</label>
	                <select name="nodesEventModel" id="nodesEventModel" class="easyui-combobox" style="width: 160px;" required="true">
	                	<option value="0">自动</option>
	                	<option value="1">手动</option>
	                </select>
	            </div>
				<div class="fitem">
	                <label style="display: inline-block;">模板</label>
	                <select id="templateId" name="templateId"  style="width: 160px"></select>
	                <!-- <ul name="templateId" id="templateId"  style="width: 160px;display: inline-block;" required="true">
	                </ul> -->
	            </div>
	            <div class="fitem">
	                <label>数据填充器</label>
	                <select name="dataFiller" id="dataFiller" class="easyui-combobox" style="width: 160px;" required="true">
	                </select>
	            </div>
	            <div class="fitem">
	                <label>相关属性</label>
	                <select name="dataFields" id="dataFields" class="easyui-combobox" style="width: 160px;" required="true" ></select>
	            </div>
	            <div class="fitem">
	                <label>涉及人员</label>
	                <select name="relevantPerson" id="relevantPerson" class="easyui-combobox" style="width: 160px;" required="true" ></select>
	            </div>
	        </form>
	    </div>
	    <div id="dlg-buttons">
