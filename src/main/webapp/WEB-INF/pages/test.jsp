...
<body class="easyui-layout" data-options="fit:true,border:false">
	flow Template id: <input type="text" class="easyui-textbox" id="templateId" required ="required" />
	process Id: <input type="text" style="  border-radius: 6px;border: 1px solid #333;" placeholder="自动填写" id="processId">
	<div id="flow" style="margin: 10px">
	</div>
	<div id="flowbtn" >
