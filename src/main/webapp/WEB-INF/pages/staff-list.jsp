...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" enctype="multipart/form-data">
			...
			<div class="fitem">
				<label>姓名:</label> <input name="staffName" class="easyui-textbox"
					required="true">
			</div>
			<div class="fitem">
				<label>职位:</label> <input name="staffPosition"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>学历:</label> <input name="staffEducation"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>照片文件:</label> <input name="staffImage" type="file" />
			</div>
			<div class="fitem">
				<label>排序:</label> <input name="od" class="easyui-numberbox"
					required="true" precision="0" value="0">
			</div>
			<div class="fitem">
				<label>人员简介:</label> <input name="staffDescription"
	...
	<div id="dlg-buttons">
		...
		<r:mulparampermission uri2="/portal/staff/save"
			uri="/portal/staff/update">
