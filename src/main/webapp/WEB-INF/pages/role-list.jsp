...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		...
		<r:mulparampermission uri2="/portal/role/update"
			uri="/portal/role/add">
	...
	<div id="dlg" class="easyui-dialog" closed="true"
		...
		<div class="layout-left"
			style="position: absolute; width: 70%; height: 80%; left: 20px; top: 40px; overflow: auto; z-index: 2;">
			<form id="roleGrantForm" method="post">
				<ul id="resourceTree"></ul>
				<input id="resourceIds" name="resourceIds" type="hidden" /> <input
					id="role-id" name="roleId" type="hidden">
			</form>
		</div>

		<div class="layout-right"
			style="position: absolute; margin: auto; left: 82%; top: 80px; overflow: hidden; z-index: 2">
		...
		<div id="dlg-buttons">
			<r:permission uri="/portal/role/grant">
				<a href="javascript:void(0)" class="easyui-linkbutton c6"
					iconCls="icon-ok" onclick="grantRight()">授权</a>
			</r:permission>
