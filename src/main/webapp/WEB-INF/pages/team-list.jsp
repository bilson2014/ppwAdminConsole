...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'north',border:false"
		...
		<form id="searchForm" method="post">
			<table>
				<tr>
					<th>团队名称：</th>
					<td><input id="search-teamName" name="teamName"
						placeholder="请输入供应商名称" /></td>
					<th>手机号：</th>
					<td><input id="search-phoneNumber" name="phoneNumber"
						placeholder="请输入手机号码" /></td>
					<th>审核状态：</th>
					<td><select id="search-flag" name="flag">
					...
					<th>价格区间</th>
					<td><select id="search-price" name="priceRange">
							<option value="" selected="selected">-- 请选择 --</option>
				...
				<tr>
					<th>联系人:</th>
					<td><input id="search-linkman" name="linkman"
						placeholder="请输入联系人" /></td>
					<th>所在省：</th>
					<td><input id="search-provinceID" name="provinceID"
						placeholder="请输入省" /></td>
					...
					<th>业务范围</th>
					<td><select id="search-business" name="business"
	...
	<div id="toolbar" style="display: none;">
		<r:permission uri="/portal/team/save">
			<a id="add-btn" onclick="addFuc();" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-add'">添加</a>
		</r:permission>

		<r:permission uri="/portal/team/update">
			<a id="edit-btn" onclick="editFuc();" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-edit'">修改</a>
		</r:permission>

		<r:permission uri="/portal/team/delete">
			<a id="del-btn" onclick="delFuc();" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-remove'">删除</a>
		</r:permission>

		<a id="cancel-btn" onclick="cancelFuc();" href="javascript:void(0);"
			class="easyui-linkbutton"
			data-options="plain:true,iconCls:'icon-cancel'">取消操作</a> <a
			id="cancel-btn" onclick="recommendFuc();" href="javascript:void(0);"
			class="easyui-linkbutton"
			data-options="plain:true,iconCls:'icon-tip'">首页推荐</a>

		<r:permission uri="/portal/product/listByTeam">
			<a id="cancel-btn" onclick="getProductsFuc();"
				href="javascript:void(0);" class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-tip'">作品列表</a>
		</r:permission>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" enctype="multipart/form-data">
			...
			<table style="width: 98%;">
				<tr>
					<th>公司名称</th>
					<td><input name="teamName" class="easyui-textbox"
						required="true"></td>
				</tr>
				<tr>
					<th>登录名</th>
					<td><input name="loginName" validtype="vLoginName"
						class="easyui-validatebox textbox" id="loginName"></td>
					<th>审核状态</th>
					<td><select id="flag" name="flag" class="easyui-combobox"
						style="width: 150px; height: 28px; line-height: 28px;"
				...
				<tr>
					...
					<td><input class="easyui-validatebox textbox"
						...
						name="phoneNumber" id="phoneNumber" required="true" /></td>
				</tr>

				<tr>
					<th>微信号</th>
					<td><input name="webchat" class="easyui-textbox"
						required="true" /></td>
					<th>QQ</th>
					<td><input name="qq" class="easyui-validatebox textbox"
						validtype="qq" /></td>
				</tr>

				<tr>
					<th colspan="2">公司LOGO</th>
					<td colspan="2"><input name="file" id="file" type="file"
						prompt="选择一个照片" /></td>
				</tr>
				...
				<tr>
					<th>邮箱</th>
					<td><input class="easyui-validatebox textbox"
						validType="email" name="email" required="true" /></td>
					<th>官方网站</th>
					<td><input class="easyui-validatebox textbox" validType="url"
						name="officialSite"
						invalidMessage="url格式不正确[http://www.example.com]" /></td>
				</tr>
				...
				<tr>
					...
					<td><input class="easyui-textbox" name="address"
						required="true" /></td>
					<th>成立时间</th>
					<td><input class="textbox" name="establishDate"
				...
				<tr>
					<th>所在省</th>
					<td><select name="teamProvince" id="teamProvince"
						class="easyui-combobox" required="true" editable="false"
						style="width: 90%;">

					</select></td>
					<th>所在城市</th>
					<td><select name="teamCity" id="teamCity"
						class="easyui-combobox" required="true" editable="false"
						style="width: 90%;">
				...
				<tr>
					<td colspan="4"><input type="checkbox" name="business"
						value="0" /> 广告 <input type="checkbox" name="business" value="16" />
						TVC <input type="checkbox" name="business" value="1" /> 宣传片 <input
						type="checkbox" name="business" value="2" /> 真人秀 <input
						type="checkbox" name="business" value="3" /> 纪录片 <input
						type="checkbox" name="business" value="4" /> 病毒视频 <input
						type="checkbox" name="business" value="5" /> 电视栏目 <input
						type="checkbox" name="business" value="17" /> MV <input
						type="checkbox" name="business" value="6" /> 三维动画 <input
						type="checkbox" name="business" value="7" /> MG动画 <input
						type="checkbox" name="business" value="8" /> 体育赛事 <input
						type="checkbox" name="business" value="9" /> 专题片 <input
						type="checkbox" name="business" value="10" /> VR拍摄 <input
						type="checkbox" name="business" value="11" /> 产品拍摄 <input
						type="checkbox" name="business" value="12" /> 微电影 <input
						type="checkbox" name="business" value="13" /> 航拍 <input
						type="checkbox" name="business" value="14" /> 活动视频 <input
						type="checkbox" name="business" value="15" /> 后期制作 <input
						type="checkbox" name="business" value="18" /> 包装</td>
				</tr>

				<tr>
					<th>价格区间</th>
					<td><select name="priceRange" class="easyui-combobox"
					...
					<th>信息来源</th>
					<td><select name="infoResource" class="easyui-combobox"
						editable="false" required="true">
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox" name="scale"
						multiline="true" style="height: 100px; width: 92%;"
						prompt="坐班人数及坐班导演或合作导演,坐班后期" required="true" /></td>
				</tr>
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox text-area"
						name="businessDesc" multiline="true"
						style="height: 150px; width: 92%;" prompt="请填写贵公司主要客户/作品以及价格" />
					</td>
				</tr>
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox text-area"
						name="demand" multiline="true" style="height: 100px; width: 92%;"
						prompt="在此填写对客户的要求" /></td>
				</tr>
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox text-area"
						name="teamDescription" multiline="true"
						style="height: 100px; width: 92%;" prompt="在此填写对公司的描述" /></td>
				</tr>
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox text-area"
						...
						style="height: 100px; width: 92%;" prompt="在此填写备注信息" /></td>
				</tr>
				...
				<tr>
					<td colspan="4"><input class="easyui-textbox text-area"
						name="recommendation" multiline="true"
						style="height: 100px; width: 92%;" prompt="在此填写审核意见" /></td>
				</tr>
	...
	<div id="dlg-buttons">
		...
		<r:mulparampermission uri2="/portal/team/save"
			uri="/portal/team/update">
			<a id="save-btn" onclick="saveFuc();" href="javascript:void(0)"
				class="easyui-linkbutton c6" iconCls="icon-ok">保存</a>
	...
	<div id="recommend-dlg" class="easyui-dialog"
		style="width: 520px; height: 480px; padding: 10px 20px" closed="true"
		buttons="#recommend-dlg-buttons" title="首页推荐">

		<input id="search-recommend-teamName" name="recommend-teamName"
			placeholder="请输入供应商名称" /> <a href="javascript:void(0);"
			id='add-recommend' class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true" onclick="">添加</a>
		<table id="recommend-gride" data-options="fit:true,border:false"></table>
	</div>
	<div id="product-dlg" class="easyui-dialog"
			...
			<div class="video-modalDialog">
				<div class="video-condition-body">
					<div class="video-operation-panel">
						<video autoplay="autoplay" style="height: 270px; width: 480px"
							id="productVideo" preload="auto" class="hide" controls="controls"
							src=""></video>
