...
<div id="toolbar" style="display: none;">
	...
	<r:permission uri="/portal/module/delete">
		<a onclick="delFun();" href="javascript:void(0);"
			class="easyui-linkbutton"
...
<div id="dlg" class="easyui-dialog"
	...
	<form id="fm" method="post" enctype="multipart/form-data">
		...
		<div class="fitem">
			<label>资源名称:</label> <input name="moduleName" class="easyui-textbox"
				required="true">
		</div>
		<div class="fitem">
			<label>图片路径:</label> <input name="moduleImg" type="file">
		</div>
		<div class="fitem">
			<label>等级:</label> <select name="moduleLevel" class="easyui-combobox"
		...
		<div class="fitem" style="display: none">
			<label>价格:</label> <input name="modulePrice" class="easyui-textbox"
				value="0">
		</div>
		<div class="fitem">
			<label>描述:</label>
			<textarea class="easyui-textbox" id="description" name="description"
				...
				style="width: 256px; height: 160px;"></textarea>
		</div>
		<div class="fitem">
			<label>上级资源:</label> <select id="pid" name="pid" style="width: 70%;"></select>
			<a class="easyui-linkbutton" href="javascript:void(0)"
				onclick="$('#pid').combotree('clear');">清空</a>
		</div>
	</form>
</div>
<div id="dlg-buttons">

	<r:mulparampermission uri2="/portal/module/update"
		uri="/portal/module/save">
...
<div id="dlg-showImg" class="easyui-dialog"
	style="width: 400px; padding: 10px 20px" closed="true"
	buttons="#dlg-buttons-img" title="资源信息">
	<img alt="" id="show-img" src="">
</div>
<div id="dlg-buttons-img">
	<a href="javascript:void(0)" class="easyui-linkbutton"
		iconCls="icon-cancel"
		onclick="javascript:$('#dlg-showImg').dialog('close')">取消</a>
</div>
