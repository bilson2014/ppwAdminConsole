...
<body class="easyui-layout" data-options="fit:true,border:false">
	   ...
	   <!-- image show content begin-->
			...
			<div class="picture-modalDialog">
				<div class="picture-condition-body">
					<div class="operation-panel">
						<img id="productPicture" src="" style="width: 640px;height: 60px;" class="hide" >
						<div class="p-label">
		...
		<div id="dlg" class="easyui-dialog" style="width:780px; height:480px;padding:10px 20px"
            closed="true" buttons="#dlg-buttons" title="人员信息">
            <form id="templateform" style="width:700px; height:400px;padding:10px 20px">
	            <div id="toolbar2">
					<a onclick="addFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">添加行</a>
					<a onclick="editFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'">修改行</a>
					<a onclick="delFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'">删除行</a>
					<a onclick="saveFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-save'">保存行</a>
					<a onclick="cancelFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'">取消操作</a> | 
					
					<a onclick="checkData();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-save'">保存模板</a>
					<a onclick="exitFuc2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-undo'">退出编辑</a>
			   </div>
