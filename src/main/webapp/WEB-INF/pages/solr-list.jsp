...
<body>
	<div class="content-wrap">
		<div class="search-content">
			<input id="solrInput" name="solrContent" type="text"
				placeholder="键入搜索信息" />
			<ul id="shelper">
		...
		</select> 时长:<select id="solr-length" name="solrLength">
			<option value="[0 TO *]">-- 全部 --</option>
			<option value="[0 TO 30]">0~30秒</option>
			<option value="[30 TO 60]">30~60秒</option>
			<option value="[60 TO *]">60秒以上</option>
		</select> 视频类型:<select id="solr-item" name="solrItem">
			<option value="*">-- 全部 --</option>
		</select> <input type="button" value="搜索" id="search-btn">
	</div>
