...
<body class="easyui-layout" data-options="fit:true,border:false">
				...
				<div class="header-right-content">
					<div class="header-right-userDest">
						<r:identity role="employee">
							欢迎   <b><r:outName /></b> <a href="javascript:void(0)" onclick="editUserPwd()" style="color: #fff">修改密码</a>
						</r:identity>
		...
		<div data-options="region:'south',border:false" style="height: 26px;line-height: 26px; overflow: hidden;text-align: center;background-color: #eee" >版权所有@拍片网 </div>
</body>
</html>