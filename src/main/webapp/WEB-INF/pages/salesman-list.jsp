...
<spring:url value="/resources/css/salesman-list.css"
	var="salesmanListCss" />
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false"
		...
		<form id="searchForm">
			<table>
				<tr>
					<th>分销人姓名:</th>
					<td><input id="search-name" name="salesmanName"
						class="easyui-textbox" placeholder="分销人名称" /></td>
		...
		<div class="picture-modalDialog">
			<div class="picture-condition-body">
				<div class="operation-panel">
					<img id="qrCode" src="" style="height: 200px; width: 200px;"
						class="hide">
					<div class="p-label">
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 350px; padding: 10px 20px" closed="true"
		buttons="#dlg-buttons" title="分销信息">
		<form id="fm" method="post">
			<input type="hidden" name="salesmanId" id="salesmanId">
			<div class="fitem">
				<label>名称:</label> <input name="salesmanName" class="easyui-textbox"
					required="true">
			</div>
			<div class="fitem">
				<label>作用范围:</label> <select name="belongs" class="easyui-combobox"
					editable="true">
			...
			<div class="fitem">
				<label>受众平台:</label> <select name="platform" class="easyui-combobox"
					editable="true">
			...
			<div class="fitem">
				<label>访问地址:</label> <input name="accessurl" id="accessurl"
					class="easyui-textbox">
			</div>
			<div class="fitem">
				<label>唯一标识:</label> <select name="uniqueId" class="easyui-combobox"
					editable="true">
			...
			<div class="fitem">
				<label>备注:</label> <input name="salesmanDescription"
					class="easyui-textbox">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
		<r:mulparampermission uri2="/portal/salesman/save"
			uri="/portal/salesman/update">
