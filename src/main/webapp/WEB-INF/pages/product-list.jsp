...
<body class="easyui-layout" data-options="fit:true,border:false">
			...
			<table>
				<tr>
					...
					<td><input id="search-teamName" name="teamName"
						placeholder="请输入团队名称" /></td>
					<th>项目名称:</th>
					<td><input id="search-productName" name="productName"
						class="easyui-textbox" placeholder="请填写作品名称" /></td>
					<th>上传时间:</th>
				...
				<tr>
					<th>是否可见：</th>
					<td><select name="visible" class="easyui-combobox"
						editable="false">
							<option value="" selected>-- 请选择 --</option>
					...
					<th>是否挂接外链：</th>
					<td><select name="hret" class="easyui-combobox"
						editable="false">
							<option value="" selected>-- 请选择 --</option>
					...
					<th>推荐值：</th>
					<td><select name="recommend" class="easyui-combobox"
						editable="false">
							<option value="" selected>-- 请选择 --</option>
					...
					<th>标签：</th>
					<td><input id="search-tags" name="tags" class="easyui-textbox"
						placeholder="请填写标签" /> <a href="javascript:void(0);"
	...
	<div id="toolbar" style="display: none;">
		...
		<r:mulparampermission uri2="/portal/product/update"
			uri="/portal/product/part/update">
		...
		<r:permission uri="/portal/set/masterWork">
			<a onclick="setMaster();" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-ok'">设为代表作</a>
		</r:permission>

		<r:permission uri="/portal/product/recommend/list">
			<a onclick="recommendFuc()" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-tip'">首页推荐</a>
		</r:permission>

		<a onclick="toPlayHtml()" href="javascript:void(0);"
			class="easyui-linkbutton"
			data-options="plain:true,iconCls:'icon-tip'">作品链接</a>

		<r:permission uri="/portal/chanpin/list">
			<a onclick="chanpinDlg()" href="javascript:void(0);"
				class="easyui-linkbutton"
				data-options="plain:true,iconCls:'icon-tip'">设置标准化</a>
		</r:permission>
	</div>

	<div id="dlg" class="easyui-dialog"
		style="padding: 5px 5px; width: 6500px; height: 500px;" closed="true"
		buttons="#dlg-buttons" title="作品信息">
		<form id="fm" method="post" enctype="multipart/form-data">
			<input id="productId" name="productId" type="hidden" /> <input
				id="visible" name="visible" type="hidden" />
			<div class="online">
				...
				<div class="d-float f-width1">
					<input id="teamId" name="teamId" required="true"
						class="p-textbox-small" />
				</div>
			</div>

			<div class="textarea-position">
				<div class="lable l-width">项目描述</div>
				<textarea class="easyui-textbox" id="pDescription"
					name="pDescription" multiline="true"
			...
			<div class="online">
				...
				<div class="d-float f-width1">
					<select name="showType" id='showType' class="easyui-combobox"
						style="width: 156px" editable="false">
				...
				<div class="d-float f-width1">
					<input id="videoLength" name="videoLength" class="easyui-numberbox"
						precision="0" />
				</div>
			</div>
			...
			<div class="online">
				...
				<div class="d-float f-width1">
					<input id="recommend" name="recommend" required="true"
						class="easyui-numberbox" style="width: 156px" precision="0" />
				</div>
				<div class="lable-right l-width">创作时间</div>
				<div class="d-float f-width1">
					<input class="textbox" name="creationTime" style="width: 156px"
						id="creationTime"
						onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
						readonly="readonly" />
				</div>
			</div>
			<input id="videoUrl" type="hidden" /> <input id="picLDUrl"
				type="hidden" />
			<div class="online">
				<div class="lable l-width">视频文件</div>
				<div class="d-float f-width" style="margin-top: 0px !important;">
					<input type="file" id="videoFile" style="width: 100%"
						name="uploadFiles" class="p-file" />
				</div>
			</div>
			<div class="online">
				<div class="lable l-width">封面图片</div>
				<div class="d-float f-width" style="margin-top: 0px !important;">
					<input type="file" id="picLDFile" style="width: 100%"
						name="uploadFiles" class="p-file" />
				</div>
			</div>
			...
			<div class="online">
				...
				<div class="d-float f-width1">
					<input type="text" id="tags" name="tags" style="width: 156px"
						required="true" class="easyui-textbox" />
				</div>

				<div class="lable-right l-width">赞值</div>
				<div class="d-float f-width1">
					<input id="supportCount" required="true" name="supportCount"
			...
			<div class="online">
				...
				<div class="d-float f-width">
					<select id="flag" name="flag" class="easyui-combobox"
				...
				<div class="d-float f-width1">
					<input id="indentProjectId" name="indentProjectId"
						class="p-textbox-small" />
				</div>
			</div>
			<div class="textarea-position">
				<div class="lable l-width">审核详情</div>
				<textarea class="easyui-textbox" id="checkDetails"
					name="checkDetails" multiline="true"
					style="height: 50px; width: 422px"></textarea>
			</div>
			<div class="textarea-position">
	...
	<div id="dlg-buttons">
		...
		<r:mulparampermission uri2="/portal/product/save"
			uri="/portal/product/update">
			...
			<div class="picture-condition-body">
				<div class="operation-panel">
					<img id="productPicture" src=""
						style="height: 360px; width: 640px;" class="hide">
					<video autoplay="autoplay" style="height: 360px; width: 640px"
						id="productVideo" preload="auto" class="hide" controls="controls"
						src=""></video>
					<div id="youku-player"
						style="height: 360px; width: 640px; display: none;"></div>
					<div class="p-label">
	...
	<!-- 产品标准化配置 弹出框 begin -->
	<div id="dlg-c" class="easyui-dialog" closed="true"
		buttons="#dlg-buttons-c" title="作品信息">
		<form id="fmx-c" method="post">
			<input id="fmxproductId" name="productId" type="hidden" />
			<div style="margin-left: 10%; margin-top: 15px">
				选择场景：
				<div class="sceneTag" name="sceneTag"></div>
			</div>
			<div style="margin-left: 10%; margin-top: 15px">
				选择产品：<select id="chanpinId" name="chanpinId" style="width: 130px"
					class="easyui-combobox" required="true"></select>
			</div>
			<div style="margin-left: 10%; margin-top: 15px">
				选择配置：<select id="config" name="configId" class="easyui-combobox"
					style="width: 130px" required="true"></select>
			</div>
		</form>
	</div>
	<div id="dlg-buttons-c">
		<a href="javascript:void(0)" class="easyui-linkbutton c6"
			iconCls="icon-ok" onclick="updateChanPin()">保存</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-cancel"
			onclick="javascript:$('#dlg-c').dialog('close')">取消</a>
	</div>
	<!-- 产品标准化配置 弹出框  end-->
