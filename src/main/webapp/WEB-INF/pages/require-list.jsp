...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		<a onclick="cancelFuc();" href="javascript:void(0);"
			...
			onclick="updatePMDialog();" href="javascript:void(0);"
			class="easyui-linkbutton"
			data-options="plain:true,iconCls:'icon-tip'">分配产品经理</a>
	</div>
	...
	<div id="pmDlg" class="easyui-dialog"
		...
		<form id="pmFm" method="post">
			...
			<div class="fitem">
				<label>产品经理:</label> <select name="employeeId" id="employeeId"
					class="easyui-combobox" required="true" style="width: 46%;">
				</select>
			</div>
			<div id="dlg-buttons">
				<a href="javascript:void(0)" class="easyui-linkbutton c6"
					iconCls="icon-ok" onclick="pmsave()">保存</a> <a
					href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-cancel"
					onclick="javascript:$('#pmDlg').dialog('close')">取消</a>
			</div>
		</form>
	</div>
