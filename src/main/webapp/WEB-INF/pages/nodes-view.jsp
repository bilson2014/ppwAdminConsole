...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			...
			<div class="fitem">
				<label>节点名称：</label> <input name="name" id="name"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>节点描述:</label> <input name="description" id="description"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>节点事件链:</label> <select name="nodesEvents" id="nodesEvents"
					style="width: 160px;">
				</select>
			</div>
		</form>
