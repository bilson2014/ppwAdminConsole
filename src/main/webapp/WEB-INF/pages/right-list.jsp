...
<div id="dlg" class="easyui-dialog"
	...
	<form id="fm" method="post" novalidate>
		...
		<div class="fitem">
			<label>资源名:</label> <input name="rightName" class="easyui-textbox"
				required="true">
		</div>
		<div class="fitem">
		...
		<div class="fitem">
			<label>排序:</label> <input name="seq" class="easyui-numberspinner"
				required="true">
		</div>
		<div class="fitem">
			<label>图标:</label> <select name="icon" class="easyui-combobox"
		...
		<div class="fitem">
			<label>类型:</label> <select name="resourceType"
		...
		<div class="fitem">
			<label>状态:</label> <select name="status" class="easyui-combobox"
				data-options="editable:false,panelHeight:'auto'" style="width: 50%;">
				<option value="1">正常</option>
				<option value="0">停用</option>
			</select>
		</div>
		<div class="fitem">
			<label>是否公共:</label> <select name="isCommon" class="easyui-combobox"
				data-options="editable:false,panelHeight:'auto'" style="width: 50%;">
...
<div id="dlg-buttons">
	...
	<r:mulparampermission uri2="/portal/right/update"
		uri="/portal/right/save">
