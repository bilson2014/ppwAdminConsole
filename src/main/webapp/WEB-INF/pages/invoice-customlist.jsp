...
<spring:url value="/resources/js/invoice-customlist.js" var="invoiceCustomListJs" />
...
<body class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',border:false" style="height: 40px; overflow: hidden;background-color: #fff">
			<form id="searchForm" method="post">
				...
				<tr>
					...
					<th>开票日期:</th>
					<td>
						<input name="invoiceBeginDate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" /> - 
						<input name="invoiceEndDate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" />
					</td>
					<td>
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="searchFun();">查询</a>
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="cleanFun();">清空</a>
						<r:permission uri="/portal/invoice/user/export">
		...
		<div id="dlg" class="easyui-dialog" style="width:360px;padding:10px 20px"
	        ...
	        <form id="fm" method="post" enctype="multipart/form-data">
	            ...
	            <div class="fitem">
	                <label>开票时间:</label>
	                <input name="invoiceStampTime"  required="true" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" required="true" />
	            </div>
	            <div class="fitem">
	                <label>视频管家领票时间:</label>
	                <input name="invoiceReceiveTime"  required="true" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" required="true" />
	            </div>
	            <div class="fitem">
	                <label>项目名称:</label>
	            ...
	            <div class="fitem">
	                <label>客户名称:</label>
	               	<input id="invoiceUserId" name="invoiceUserId" class="easyui-combobox" required="true" />
	            </div>
	            <div class="fitem">
	                <label>领取人:</label>
