...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" enctype="multipart/form-data">
			...
			<div class="fitem">
				<label>登录名:</label> <input name="managerLoginName"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>姓名:</label> <input name="managerRealName"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>密码:</label> <input name="managerPassword" type="password"
					class="easyui-textbox" prompt="Password" iconCls="icon-lock">
			</div>
			<div class="fitem">
				<label>手机:</label> <input class="easyui-validatebox textbox"
					validtype="mobile" name="phoneNumber" required="true" />
			</div>
			<div class="fitem">
				<label>邮箱:</label> <input class="easyui-validatebox"
					validType="email" name="managerEmail" required="true" />
			</div>
			<div class="fitem">
				<label>描述:</label> <input class="easyui-textbox"
					name="managerDescription" multiline="true" style="height: 100px;" />
			</div>
		</form>
	</div>
	<div id="dlg-buttons">

		<r:mulparampermission uri2="/portal/manager/save"
			uri="/portal/manager/update">
