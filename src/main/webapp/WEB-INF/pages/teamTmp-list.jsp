		...
		<div id="dlg" class="easyui-dialog" style="padding:5px 5px;width: 520px;height: 500px;"
	        ...
	        <form id="fm" method="post" enctype="multipart/form-data">
				...
				<div class="online">
					...
					<select name="checkStatus" class="easyui-combobox" editable="false" required="true" style="width: 150px;">
				...
				<div class="online">
					...
					<input class="easyui-textbox text-area" name="checkDetails" multiline="true" style="height: 100px;width: 92%;" prompt="再此填写审核详情" />
				</div>
	        </form>
	    </div>
	    <div id="dlg-buttons">
