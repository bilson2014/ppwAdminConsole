...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false"
		...
		<form id="searchForm">
			<table>
				<tr>
					<th>姓名:</th>
					<td><input name="activityName" id="searchFormactivityName"
						placeholder="请输入活动名称" /></td>
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 380px; height: 500px;" closed="true"
		buttons="#dlg-buttons" title="人员信息">
		<form id="fm">
			<input type="hidden" name="activityId" id="activityId">
			<div class="fitem">
				<label>活动名称：</label> <input id="activityName" name="activityName"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>类型：</label> <select id="acticityTempleteType"
					name="acticityTempleteType" class="easyui-combobox" required="true">
					<option value="0">短信</option>
					<option value="1">邮件</option>
				</select>
			</div>
			<div class="fitem">
				<label>模板：</label> <input id="acticityTempleteId"
					name="acticityTempleteId" class="easyui-combobox" required="true">
			</div>
			<div>
				<label>模板内容：</label><br /> <span id="templateValue"></span>
			</div>
			<div class="fitem">
				<label>参数列表：</label> <a id="addSystemParam" href="#"
					class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加系统参数</a>
				<a id="addCustomParam" href="#" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'">添加自定义参数</a><br />
				-----------------------------------------------------
				<div id="paramList"></div>
				-----------------------------------------------------
			</div>
			<div class="fitem">
				<label>启动时间：</label> <input id="activityStartTime"
					name="activityStartTime" class="easyui-datetimebox" required="true">
			</div>

			<div class="fitem">
				<label>相关人员：</label> <select id="actitityRelevantPersons"
					name="actitityRelevantPersons" class="easyui-combobox"
					required="true">
