...
public class SessionInfoServiceImpl implements SessionInfoService {
	...
	public boolean addSession(final HttpServletRequest request,
	...
	public boolean addSessionSeveralTime(final HttpServletRequest request,
			final Map<String, Object> map,int time) {
	...
	public void updateSession(final HttpServletRequest request, final String filed,
			final String value) {
