...
public class SMSTemplateController extends BaseController {
	...
	@RequestMapping("/get/smstemplate")
	public BaseMsg getTemplateValue(String templateKey) {
		String templateValue = smsService.getTemplateValue(templateKey);
		return new BaseMsg(BaseMsg.NORMAL, "", templateValue);
	}
}
