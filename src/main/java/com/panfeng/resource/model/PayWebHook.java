...
public class PayWebHook extends BaseObject {
	...
	public String toString() {
		...
		stringBuffer
				.append(channel_type != null ? channel_type.toString() : "");
		stringBuffer.append(" sub_channel_type:");
		stringBuffer.append(sub_channel_type != null ? sub_channel_type
				.toString() : "");
		stringBuffer.append(" transaction_type:");
		stringBuffer.append(transaction_type != null ? transaction_type
				.toString() : "");
		...
		stringBuffer.append(transaction_fee != null ? transaction_fee
				.toString() : "");
