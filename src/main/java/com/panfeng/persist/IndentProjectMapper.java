...
public interface IndentProjectMapper {
	...
	public long updateBack(IndentProject indentProject);
	...
	public long updateStateBack(@Param("id") final long id, @Param("state") int state,@Param("description") String msg);
