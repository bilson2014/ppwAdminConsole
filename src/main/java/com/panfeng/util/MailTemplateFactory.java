...
public class MailTemplateFactory {
	...
	public static String addHtml(String tmp) {
		String str = " "+
				...
				"    <div class='page' style='position:relative;width: 859px;margin: 0 auto;'>                                                                                                                                                                                                                                                                                                                                                              "+
				"        <div class='contentArea' style='-moz-box-shadow: 0px 0px 10px #d1d1d1;-webkit-box-shadow: 0px 0px 10px #d1d1d1;-o-box-shadow: 0px 0px 10px #d1d1d1;box-shadow: 0px 0px 10px #d1d1d1;position: relative;z-index:5;width:751px;margin: 0 auto;'>                                                                                                                                                                                     "+
				...
				"                <a href='http://www.apaipian.com/' style='text-decoration:none;display: inline-block;color: white;vertical-align: top;font-size:14px;line-height: 103px;position: relative;left:230px;'>进入官网>></a>                                                                                                                                                                                                                     "+
				"            </div>                                                                                                                                                                                                                                                                                                                                                                                                                         "+
				...
				"                </ul>                                                                                                                                                                                                                                                                                                                                                                                                                      "+
				"            </div>                                                                                                                                                                                                                                                                                                                                                                                                                         "+
				"            <div class='content' style='padding: 40px 20px 50px 20px; height: auto;background: white;width:711px'>                                                                                                                                                                                                                                                                                                                        "+
				tmp+
				"            </div>                                                                                                                                                                                                                                                                                                                                                                                                                         "+
				"        </div>                                                                                                                                                                                                                                                                                                                                                                                                                             "+
				"         <a href='http://www.apaipian.com' style='cursor: pointer'>                                                                                                                                                                                                                                                                                                                                                                        "+
				"             <img class='foot' style='width:860px;z-index:5;position: relative; bottom: 0px;left:0px;'  src='http://resource.apaipian.com/resource/group1/M00/00/38/CgpmTlhHuk-AFncVAAQro7B50-g596.png'/>                                                                                                                                                                                                                                   "+
				"         </a>                                                                                                                                                                                                                                                                                                                                                                                                                              "+
				"    </div>                                                                                                                                                                                                                                                                                                                                                                                                                                 "+
				"</body>     "+                                                                                                                                                                                                                                                                                                                                                                                                                              
				"</html> ";
